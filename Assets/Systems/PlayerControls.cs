...
namespace AM
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""E_keyboard"",
                    ""type"": ""Button"",
                    ""id"": ""daa7859a-3102-4943-8f01-4b8faf641147"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b0e2c9a1-1491-4cfd-8f40-dbb05adea80c"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
            ...
            m_PlayerMovement_E_keyboard = m_PlayerMovement.FindAction("E_keyboard", throwIfNotFound: true);
            // Player Actions
        ...
        private readonly InputAction m_PlayerMovement_E_keyboard;
        public struct PlayerMovementActions
        {
            ...
            public InputAction @E_keyboard => m_Wrapper.m_PlayerMovement_E_keyboard;
            ...
            public void SetCallbacks(IPlayerMovementActions instance)
            {
                if (m_Wrapper.m_PlayerMovementActionsCallbackInterface != null)
                {
                    ...
                    @E_keyboard.started -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnE_keyboard;
                    @E_keyboard.performed -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnE_keyboard;
                    @E_keyboard.canceled -= m_Wrapper.m_PlayerMovementActionsCallbackInterface.OnE_keyboard;
                }
                ...
                if (instance != null)
                {
                    ...
                    @E_keyboard.started += instance.OnE_keyboard;
                    @E_keyboard.performed += instance.OnE_keyboard;
                    @E_keyboard.canceled += instance.OnE_keyboard;
                }
            }
        }
        ...
        public interface IPlayerMovementActions
        {
            ...
            void OnE_keyboard(InputAction.CallbackContext context);
        }
